...
public class MemberMenu {
	...
	public Map<String, String> inputMember() {
		...
		System.out.print("등록할 멤버 ID 입력해 주세요 : ");
		String memberId = sc.nextLine();
		System.out.print("등록할 멤버 PWD 입력해 주세요 : ");
		String memberPwd = sc.nextLine();
		System.out.print("등록할 멤버 NAME 입력해 주세요 : ");
		String memberName = sc.nextLine();
		System.out.print("등록할 멤버 GENDER 입력해 주세요 : ");
		String gender = sc.nextLine();
		System.out.print("등록할 멤버 EMAIL 입력해 주세요 : ");
		String email = sc.nextLine();
		System.out.print("등록할 멤버 PHONE 입력해 주세요 : ");
		String phone = sc.nextLine();
		System.out.print("등록할 멤버 ADDRESS 입력해 주세요 : ");
		String address = sc.nextLine();
		System.out.print("등록할 멤버 AGE 입력해 주세요 : ");
		String age = sc.nextLine();
		System.out.print("등록할 멤버 ENROLL_DATE 입력해 주세요 : ");
